...
export const PauseCircleIcon = ({ size = 1, ...props }) => {
    return (
        <svg
            aria-hidden="true"
            fill="none"
...
export const NextIcon = ({ size = 1, ...props }) => {
    return (
        <svg
            aria-hidden="true"
            fill="none"
...
export const PreviousIcon = ({ size = 1, ...props }) => {
    return (
        <svg
            aria-hidden="true"
            fill="none"
...
export const RepeatOneIcon = ({ size = 1, ...props }) => {
    return (
        <svg
            aria-hidden="true"
            fill="none"
...
export const ShuffleIcon = ({ size = 1, ...props }) => {
    return (
        <svg
            aria-hidden="true"
            fill="none"
...
export const ExternalLinkIcon = ({ size = 1, ...props }) => {
    return (
        <svg
            aria-hidden="true"
            fill="none"
